...
const QuestionCreate: FC<IProps> = (p) => {
	const {
		...
		changeAnswerValueHandler,
		destroyAnswerHandler,
	} = p
	...
	return (
		<QuestionLayout>
			<div className='flex items-center gap-4 '>
				...
				/>
				<div onClick={() => destroyQuesHandler(item.id)}>
			...
			<div className=' relative'>
				<div className='flex flex-col gap-1'>
					{item.answers.arr.map((answer, index) => (
						<Answer
...
interface IProps {
	...
	destroyQuesHandler: (id: number) => void
}
